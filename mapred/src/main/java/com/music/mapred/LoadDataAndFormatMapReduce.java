...
public class LoadDataAndFormatMapReduce {
    ...
    public static class LoadDataAndFormatMapper
    ...
    public static class LoadDataAndFormatReducer
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setJarByClass(LoadDataAndFormatMapReduce.class);        // 指明 MR Job 对应执行的类 （Controller Class）
        ...
        // 2. 指明 Mapper 类
        // 2-0. Mapper 类
        job.setMapperClass(LoadDataAndFormatMapper.class);
        ...
        // 6-1. reducer的类
        job.setReducerClass(LoadDataAndFormatReducer.class);
